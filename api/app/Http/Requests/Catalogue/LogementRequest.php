...
class LogementRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            // Un logement sans type ne peut pas être chiffré (CdC § 7.1).
            ...
            // Mise en avant page d'accueil (CdC § 5.1) : simple bascule éditoriale, sans double validation.
    ...
    {
        return ['equipements.*.exists' => 'Cet équipement n’est pas un équipement de logement.'];
    }
}
